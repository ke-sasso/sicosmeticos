...
<div class="row">
	<div class="col-sm-12">
		<div class="the-box">
		 <form role="form" method="POST" action="{{route('actualizarClassHig')}}">
				<input type="hidden" name="_token" value="{{ csrf_token() }}" class="form-control"/>
				<input type="hidden" name="id" value="{{ $class->idClasificacion }}" class="form-control"/>
				<div class="group-control">
				<label>Nombre de Clasificación:</label>
				<input type="text" name="nombre" class="form-control" style="text-transform:uppercase;" value="{{$class->nombreClasificacion}}"></input>
				</div></br>
				
				<div class="group-control"><br/>
				   <label>Posee:</label>
				</div>
						@if($class->poseeTono==1&&$class->poseeFragancia==1)
						<div class="checkbox">
						...
						@elseif ($class->poseeTono==1&&$class->poseeFragancia==0)
						<div class="checkbox">
						   <label><input type="checkbox" name="tono" value="1" checked="true">Tono</label>
						</div>
						<div class="checkbox">
						...
						@elseif($class->poseeTono==0&&$class->poseeFragancia==1)
						<div class="checkbox">
