        ...
        <div class="panel-heading" >
            <h3 class="panel-title">
                <a class="block-collapse collapsed" id='colp' data-toggle="collapse" href="#collapse-filter">
                    B&uacute;squeda Avanzada de Productos Cosméticos
                ...
                <form role="form" id="search-form">
                    <div class="row">
                        <div class="form-group col-sm-6 col-md-3">
                            <label>N° de Cosmético:</label>
                            <input type="text" class="form-control" name="ncosmetico" id="ncosmetico" autocomplete="off">
                        </div>
                        ...
                        <div class="form-groupcol-sm-6 col-md-3">
                            ...
                            <select name="tipo" id="tipo" class="form-control">
                              ...
                              <option value="1">REGISTRO COSMÉTICO</option>
                              <option value="2">RECONOCIMIENTO COSMÉTICO</option>
                            </select>
                        </div>
...
$(document).ready(function(){
  var table = $('#dt-cos').DataTable({
        ...
        order: [[ 0, "asc" ]],
        ajax:{
        	url: "{{route('dt.row.data.cos')}}",
            data: function(d){
                d.ncosmetico = $('#ncosmetico').val();
        ...
        columns:[
        		{data:'idCosmetico', name:'idCosmetico',orderable:true},
        		{data:'nombreComercial', name:'nombreComercial',orderable:true},
        		{data:'tipo', name:'tipo',orderable:true},
        		{data:'vigenciaHasta', name:'vigenciaHasta',orderable:true},
