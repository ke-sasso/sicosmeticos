 ...
 ?>
				...
				<div class="row">
					...
					<div class="col-xs-6">
						...
						<input type="text" name="fecha" class="form-control" value="{{$solicitud->fechaCreacion}}" readonly="true">
					</div>
                 </div>		
...
<!-- verifico que el index del arreglo de apartados para que no acceda a una posicion no existente