...
@section('contenido')
    ...
    @endif
        <div class="row">
            <div class="col-md-12">
                <form name="asignarSolUsuario" id="asignarSolUsuario" method="POST" role="form" action="{{route('solicitudes.post.asignaciones.store')}}">
                    <div id="sol"></div>
                    <div class="col-md-6">
                           @if($asignados)
                    ...
                    <div class="col-md-6">
                         ...
                         <a href="{{route('solicitudes.post.nueva.asignaciones')}}" class="btn btn-info"><b><i class="fa  fa-mail-reply"></i></b>Regresar</a>
                    </div>
