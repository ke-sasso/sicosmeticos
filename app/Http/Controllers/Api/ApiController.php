...
class ApiController extends Controller
{
    ...
    public function pdfResolucionBySol($idSol)
    {
        $dictamen=Dictamen::getDictamenBySol($idSol);
        ...
        //CONSULTAMOS EL PDF DE LA RESOLUCIÓN DEL DICTAMEN
        ...
        if(!empty($docresul)){
               if (File::isFile($docresul->urlArchivo)){
                        ...
                        Log::warning('PORTAL EN LÍNEA: USUARIO DE LA SOLICITUD PRE '.$idSol.' NO PUEDE VER PDF DE RESOLUCIÓN, NO EXISTE CARPETA');
                        return "¡ADVERTENCIA: no se puede ver el documento PDF de la resolución, es necesario notificar al correo: cosmeticos.higienicos@medicamentos.gob.sv enviando el número de solicitud!";

                }
        }else{
            Log::warning('PORTAL EN LÍNEA: USUARIO DE LA SOLICITUD PRE '.$idSol.' NO PUEDE VER PDF DE RESOLUCIÓN');
            return "¡ADVERTENCIA: no se puede ver el documento PDF de la resolución, es necesario notificar al correo: cosmeticos.higienicos@medicamentos.gob.sv enviando el número de solicitud!";
